...
Mobile today maps **404** to: _Payment links aren’t available yet. Try again later._ That was for the route missing. The route exists now — treat 404 as “no business,” and use **422** for “finish Stripe setup.”
