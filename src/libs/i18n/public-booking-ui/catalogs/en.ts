...
export const publicBookingUiEn: PublicBookingUi = {
  ...
  multiJob: {
    ...
    petPerService: 'Pet for each service',
    ...
    petRequiredToast:
      'Add pet name, species, breed, and size for each service before continuing.',
    petRequiredToastForJob: name =>
      `Add pet details for ${name} before continuing.`,
    maxJobsReachedToast:
  ...
  customerForm: {
    ...
    pet: 'Pet',
    optionalPetDetails: 'Optional — add pet details.',
    petName: 'Pet name',
    petNamePlaceholder: 'Buddy',
    petSpecies: 'Species',
    petSpeciesPlaceholder: 'Select species',
    petBreed: 'Breed',
    petBreedPlaceholder: 'Golden Retriever',
    petSize: 'Size',
    petSizePlaceholder: 'Select size',
    speciesDog: 'Dog',
    speciesCat: 'Cat',
    sizeSmall: 'Small',
    sizeMedium: 'Medium',
    sizeLarge: 'Large',
    sizeXl: 'Extra large',
    errPetName: 'Pet name is required',
    errPetSpecies: 'Species is required',
    errPetBreed: 'Breed is required',
    errPetSize: 'Size is required',
  ...
  subscriptions: {
    ...
    plansLoadError: 'Plans could not be loaded. Please try again.',
    plansRetry: 'Try again',
    plansLoadingAriaLabel: 'Loading subscriptions',
  ...
  profile: {
    ...
    quotePageSubtitle: businessName =>
      `Tell ${businessName} what you need. They’ll send a price.`,
    ...
    workPhotoAlt: (businessName, index, total) =>
      `${businessName} work photo ${index} of ${total}`,
    lightboxClose: 'Close',
    lightboxPrevious: 'Previous photo',
    lightboxNext: 'Next photo',
    lightboxPhotoPosition: (current, total) => `${current} of ${total}`,
    bioTab: 'Bio',
    reviewsTab: 'Reviews',
    ...
    galleryLoadError: 'Photos could not be loaded. Please try again.',
    galleryRetry: 'Try again',
    galleryLoadingAriaLabel: 'Loading gallery',
  ...
  quoteForm: {
    quoteDetails: 'Your request',
    whenOptional: 'When? (optional)',
    whenLabel: 'When?',
    whenPlaceholder: 'Select timeline',
    detailsLabel: 'Describe the job',
    successDetailsLabel: 'Request',
    detailsPlaceholder:
    ...
    reviewSubtitle: 'Make sure everything looks right before you send it.',
    ...
    successSubtitle: (businessName: string) =>
      `${businessName} has your request. They’ll get back to you by email or phone.`,
    successCardHeader: 'Your request',
    successBack: 'Back to profile',
    timelineAsap: 'ASAP',
    ...
    errDetails: 'Add a short message',
