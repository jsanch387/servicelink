...
export default function WaitlistPage() {
  ...
  const { isLoading, isSubmitted, error, successMessage, submitEmail, reset } =
    useWaitlist();
        ...
        <div className="max-w-md w-full text-center">
          <div className="bg-neutral-800 rounded-2xl p-8 border border-neutral-700">
            ...
            <p className="text-gray-300 mb-6">
              Thanks for joining our waitlist. We&apos;ll email you at{' '}
              <strong className="text-orange-400">{email}</strong> when we
              launch.
            </p>
