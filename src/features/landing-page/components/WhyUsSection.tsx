      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 md:gap-12 text-left">
          <div className="space-y-3 sm:space-y-4">
            <h4 className="text-lg sm:text-xl font-bold text-orange-400">Websites are 2005.</h4>
          ...
          <div className="space-y-3 sm:space-y-4">
            <h4 className="text-lg sm:text-xl font-bold text-orange-400">Social Bios are for hobbyists.</h4>
            <p className="text-gray-400 text-xs sm:text-sm leading-relaxed">
