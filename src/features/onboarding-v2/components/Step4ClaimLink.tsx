...
export const Step4ClaimLink: React.FC<Step4ClaimLinkProps> = ({
  ...
  return (
    <div className="w-full">
      ...
      <div className="rounded-2xl border border-white/10 bg-white/[0.02] overflow-hidden p-4">
        <div className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex flex-col sm:flex-row sm:items-stretch rounded-xl border border-white/10 bg-white/[0.04] overflow-hidden focus-within:border-white/30 focus-within:ring-1 focus-within:ring-white/20">
              <span className="flex items-center py-2.5 px-4 sm:py-0 text-gray-500 font-mono text-xs sm:text-sm border-b border-white/10 sm:border-b-0 sm:border-r flex-shrink-0">
                {APP_DOMAIN}/
              </span>
              <input
                type="text"
      ...
      <OnboardingStepNav onBack={onBack} backDisabled={saving}>
        <Button
          type="button"
          onClick={handleClaim}
          variant="inverse"
