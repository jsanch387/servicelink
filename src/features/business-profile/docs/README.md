...
- Public V2 booking UI and `POST /api/public/bookings`: `src/features/availability/docs/FLOWS.md`
- Quote request flow: `src/features/quotes/docs/PUBLIC_QUOTE_REQUEST_AND_BOOKING_FLOW.md`
