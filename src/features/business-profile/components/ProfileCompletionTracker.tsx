...
export function ProfileCompletionTracker({
  ...
  return (
    <div className="border-b border-white/[0.06] py-4 pr-4 pl-2 sm:pl-4">
      <button
        type="button"
        onClick={onViewChecklist}
        className="group flex w-full items-center gap-3 text-left transition-opacity hover:opacity-90"
