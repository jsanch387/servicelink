    ...
    <div className="grid gap-4 sm:gap-6 lg:grid-cols-2">
      <GlassCard padding="none" rounded="rounded-2xl" className="p-4 sm:p-8">
        ...
        <p className="mt-3 text-xs text-gray-500">
          Sample data — connects to Stripe when payouts are enabled.
        </p>
      </GlassCard>
      ...
      <GlassCard padding="none" rounded="rounded-2xl" className="p-4 sm:p-8">
        ...
        <p className="mt-1 text-sm text-gray-400 leading-relaxed">
          View charges, payouts, and tax documents in your Stripe Dashboard.
          Payout bank details stay in Settings.
        </p>
