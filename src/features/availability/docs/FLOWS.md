...
#### Service location on the business profile (address step — not wired yet)
...
The public book flow **still always shows** the customer address step today. Planned: skip or branch that step by mode (shop = business address only; both = customer picks mobile vs shop). Full schema, validation, and file map: **[serviceLocation.md](../../business-profile/docs/serviceLocation.md)**.
...
| Business service location (mobile/shop/both)      | `business_profiles` columns + [serviceLocation.md](../../business-profile/docs/serviceLocation.md) — public book branching TBD |
